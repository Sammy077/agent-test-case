...
const prefix=`process.env.SERVERLESS='true';process.env.DEMO_MODE='true';process.env.APP_SECRET='shared-test-secret';process.env.TURSO_DATABASE_URL='libsql://fixture.turso.io';process.env.TURSO_AUTH_TOKEN='fixture';const Real=require('libsql');require.cache[require.resolve('libsql')].exports=class extends Real{constructor(url,options){super(${JSON.stringify(file)},{timeout:30})}};`;
