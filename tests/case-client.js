...
(async()=>{
 ...
 await vm.runInContext('admin()',context);assert.match(element.innerHTML,/<small class="case-subcategory">Legacy classification<\/small>/);assert.match(element.innerHTML,/data-filter="sortBy"/);assert.match(element.innerHTML,/data-filter="orderBy"/);
